...
set(_exported_libraries "VacuumGripperPlugin;conveyor_belt_plugin;agv_plugin;assembly_lock_plugin;assembly_state_publisher;GripperColorPlugin;disable_shadows_plugin;ObjectDisposalPlugin;AGVTrayPlugin;TaskManagerPlugin")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'ariac_plugins' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND ariac_plugins_LIBRARIES ${_cfg} "${_lib}")
