...
set(_exported_libraries "AriacRayPlugin;AriacCameraPlugin;AriacLogicalCameraPlugin")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'ariac_sensors' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND ariac_sensors_LIBRARIES ${_cfg} "${_lib}")
