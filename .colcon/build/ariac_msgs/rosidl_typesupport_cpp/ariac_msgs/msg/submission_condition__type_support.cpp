...
static const _SubmissionCondition_type_support_symbol_names_t _SubmissionCondition_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ariac_msgs, msg, SubmissionCondition)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ariac_msgs, msg, SubmissionCondition)),
  }
};
...
{
  return &::ariac_msgs::msg::rosidl_typesupport_cpp::SubmissionCondition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ariac_msgs, msg, SubmissionCondition)() {
  return get_message_type_support_handle<ariac_msgs::msg::SubmissionCondition>();
}
