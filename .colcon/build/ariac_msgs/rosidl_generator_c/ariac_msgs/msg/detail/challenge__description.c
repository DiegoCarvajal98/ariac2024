...
static char ariac_msgs__msg__Challenge__FIELD_NAME__type[] = "type";
static char ariac_msgs__msg__Challenge__FIELD_NAME__faulty_part_challenge[] = "faulty_part_challenge";
static char ariac_msgs__msg__Challenge__FIELD_NAME__dropped_part_challenge[] = "dropped_part_challenge";
static char ariac_msgs__msg__Challenge__FIELD_NAME__sensor_blackout_challenge[] = "sensor_blackout_challenge";
static char ariac_msgs__msg__Challenge__FIELD_NAME__robot_malfunction_challenge[] = "robot_malfunction_challenge";

static rosidl_runtime_c__type_description__Field ariac_msgs__msg__Challenge__FIELDS[] = {
  {
    {ariac_msgs__msg__Challenge__FIELD_NAME__type, 4, 4},
    {
  ...
  {
    {ariac_msgs__msg__Challenge__FIELD_NAME__faulty_part_challenge, 21, 21},
    {
  ...
  {
    {ariac_msgs__msg__Challenge__FIELD_NAME__dropped_part_challenge, 22, 22},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {ariac_msgs__msg__Challenge__FIELD_NAME__sensor_blackout_challenge, 25, 25},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {ariac_msgs__msg__Challenge__FIELD_NAME__robot_malfunction_challenge, 27, 27},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription ariac_msgs__msg__Challenge__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {ariac_msgs__msg__Challenge__FIELDS, 5, 5},
    },
    {ariac_msgs__msg__Challenge__REFERENCED_TYPE_DESCRIPTIONS, 11, 11},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[1].fields = ariac_msgs__msg__DroppedPartChallenge__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[2].fields = ariac_msgs__msg__FaultyPartChallenge__get_type_description(NULL)->type_description.fields;
    assert(0 == memcmp(&ariac_msgs__msg__Part__EXPECTED_HASH, ariac_msgs__msg__Part__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[3].fields = ariac_msgs__msg__Part__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[4].fields = ariac_msgs__msg__PartPlaceCondition__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[5].fields = ariac_msgs__msg__RobotMalfunctionChallenge__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[6].fields = ariac_msgs__msg__Robots__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[7].fields = ariac_msgs__msg__SensorBlackoutChallenge__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[8].fields = ariac_msgs__msg__Sensors__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[9].fields = ariac_msgs__msg__SubmissionCondition__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[10].fields = ariac_msgs__msg__TimeCondition__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
static char toplevel_type_raw_source[] =
  "uint8 FAULTY_PART=0\n"
  "uint8 DROPPED_PART=1\n"
  "uint8 SENSOR_BLACKOUT=2\n"
  "uint8 ROBOT_MALFUNCTION=3\n"
  "\n"
  "\n"
  "uint8 type\n"
  "ariac_msgs/FaultyPartChallenge faulty_part_challenge\n"
  "ariac_msgs/DroppedPartChallenge dropped_part_challenge\n"
  "ariac_msgs/SensorBlackoutChallenge sensor_blackout_challenge\n"
  "ariac_msgs/RobotMalfunctionChallenge robot_malfunction_challenge";
...
ariac_msgs__msg__Challenge__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *ariac_msgs__msg__Challenge__get_individual_type_description_source(NULL),
    sources[1] = *ariac_msgs__msg__Condition__get_individual_type_description_source(NULL);
    sources[2] = *ariac_msgs__msg__DroppedPartChallenge__get_individual_type_description_source(NULL);
    sources[3] = *ariac_msgs__msg__FaultyPartChallenge__get_individual_type_description_source(NULL);
    sources[4] = *ariac_msgs__msg__Part__get_individual_type_description_source(NULL);
    sources[5] = *ariac_msgs__msg__PartPlaceCondition__get_individual_type_description_source(NULL);
    sources[6] = *ariac_msgs__msg__RobotMalfunctionChallenge__get_individual_type_description_source(NULL);
    sources[7] = *ariac_msgs__msg__Robots__get_individual_type_description_source(NULL);
    sources[8] = *ariac_msgs__msg__SensorBlackoutChallenge__get_individual_type_description_source(NULL);
    sources[9] = *ariac_msgs__msg__Sensors__get_individual_type_description_source(NULL);
    sources[10] = *ariac_msgs__msg__SubmissionCondition__get_individual_type_description_source(NULL);
    sources[11] = *ariac_msgs__msg__TimeCondition__get_individual_type_description_source(NULL);
    constructed = true;
  }
