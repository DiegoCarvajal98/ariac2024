...
ariac_msgs__msg__OrderCondition__create()
{
  ...
  ariac_msgs__msg__OrderCondition * msg = (ariac_msgs__msg__OrderCondition *)allocator.allocate(sizeof(ariac_msgs__msg__OrderCondition), allocator.state);
  if (!msg) {
    return NULL;
  }
...
ariac_msgs__msg__OrderCondition__Sequence__init(ariac_msgs__msg__OrderCondition__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ariac_msgs__msg__OrderCondition *)allocator.zero_allocate(size, sizeof(ariac_msgs__msg__OrderCondition), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ariac_msgs__msg__OrderCondition__Sequence * array = (ariac_msgs__msg__OrderCondition__Sequence *)allocator.allocate(sizeof(ariac_msgs__msg__OrderCondition__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  ariac_msgs__msg__OrderCondition__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ariac_msgs__msg__OrderCondition * data =
      (ariac_msgs__msg__OrderCondition *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ariac_msgs__msg__OrderCondition__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ariac_msgs__msg__OrderCondition__fini(&output->data[i]);
        }
        return false;
      }
    }
