...
ariac_msgs__msg__AssemblyStationState__create()
{
  ...
  ariac_msgs__msg__AssemblyStationState * msg = (ariac_msgs__msg__AssemblyStationState *)allocator.allocate(sizeof(ariac_msgs__msg__AssemblyStationState), allocator.state);
  if (!msg) {
    return NULL;
  }
...
ariac_msgs__msg__AssemblyStationState__Sequence__init(ariac_msgs__msg__AssemblyStationState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ariac_msgs__msg__AssemblyStationState *)allocator.zero_allocate(size, sizeof(ariac_msgs__msg__AssemblyStationState), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ariac_msgs__msg__AssemblyStationState__Sequence * array = (ariac_msgs__msg__AssemblyStationState__Sequence *)allocator.allocate(sizeof(ariac_msgs__msg__AssemblyStationState__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  ariac_msgs__msg__AssemblyStationState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ariac_msgs__msg__AssemblyStationState * data =
      (ariac_msgs__msg__AssemblyStationState *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ariac_msgs__msg__AssemblyStationState__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ariac_msgs__msg__AssemblyStationState__fini(&output->data[i]);
        }
        return false;
      }
    }
