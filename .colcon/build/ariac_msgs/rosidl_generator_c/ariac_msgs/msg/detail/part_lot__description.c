...
static char ariac_msgs__msg__PartLot__FIELD_NAME__part[] = "part";
static char ariac_msgs__msg__PartLot__FIELD_NAME__quantity[] = "quantity";

static rosidl_runtime_c__type_description__Field ariac_msgs__msg__PartLot__FIELDS[] = {
  {
    {ariac_msgs__msg__PartLot__FIELD_NAME__part, 4, 4},
    {
  ...
  {
    {ariac_msgs__msg__PartLot__FIELD_NAME__quantity, 8, 8},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription ariac_msgs__msg__PartLot__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {ariac_msgs__msg__Part__TYPE_NAME, 19, 19},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {ariac_msgs__msg__PartLot__FIELDS, 2, 2},
    },
    {ariac_msgs__msg__PartLot__REFERENCED_TYPE_DESCRIPTIONS, 1, 1},
  };
  if (!constructed) {
...
ariac_msgs__msg__PartLot__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *ariac_msgs__msg__PartLot__get_individual_type_description_source(NULL),
