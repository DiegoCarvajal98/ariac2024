...
static char ariac_msgs__msg__CombinedTask__FIELD_NAME__station[] = "station";
static char ariac_msgs__msg__CombinedTask__FIELD_NAME__parts[] = "parts";

static rosidl_runtime_c__type_description__Field ariac_msgs__msg__CombinedTask__FIELDS[] = {
  {
    {ariac_msgs__msg__CombinedTask__FIELD_NAME__station, 7, 7},
    {
  ...
  {
    {ariac_msgs__msg__CombinedTask__FIELD_NAME__parts, 5, 5},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription ariac_msgs__msg__CombinedTask__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {ariac_msgs__msg__AssemblyPart__TYPE_NAME, 27, 27},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {ariac_msgs__msg__CombinedTask__FIELDS, 2, 2},
    },
    {ariac_msgs__msg__CombinedTask__REFERENCED_TYPE_DESCRIPTIONS, 9, 9},
  };
  if (!constructed) {
...
static char toplevel_type_raw_source[] =
  ...
  "uint8 AS4=4\n"
  "\n"
  "uint8 station # AS1, AS2, AS3, or AS4\n"
...
ariac_msgs__msg__CombinedTask__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *ariac_msgs__msg__CombinedTask__get_individual_type_description_source(NULL),
