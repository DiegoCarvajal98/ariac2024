...
static char ariac_msgs__msg__AssemblyPart__FIELD_NAME__part[] = "part";
static char ariac_msgs__msg__AssemblyPart__FIELD_NAME__assembled_pose[] = "assembled_pose";
static char ariac_msgs__msg__AssemblyPart__FIELD_NAME__install_direction[] = "install_direction";

static rosidl_runtime_c__type_description__Field ariac_msgs__msg__AssemblyPart__FIELDS[] = {
  {
    {ariac_msgs__msg__AssemblyPart__FIELD_NAME__part, 4, 4},
    {
  ...
  {
    {ariac_msgs__msg__AssemblyPart__FIELD_NAME__assembled_pose, 14, 14},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {ariac_msgs__msg__AssemblyPart__FIELD_NAME__install_direction, 17, 17},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription ariac_msgs__msg__AssemblyPart__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {ariac_msgs__msg__Part__TYPE_NAME, 19, 19},
    {NULL, 0, 0},
  },
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {ariac_msgs__msg__AssemblyPart__FIELDS, 3, 3},
    },
    {ariac_msgs__msg__AssemblyPart__REFERENCED_TYPE_DESCRIPTIONS, 8, 8},
  };
  if (!constructed) {
...
ariac_msgs__msg__AssemblyPart__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *ariac_msgs__msg__AssemblyPart__get_individual_type_description_source(NULL),
