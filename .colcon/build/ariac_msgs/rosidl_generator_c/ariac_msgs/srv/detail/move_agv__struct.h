...
enum
{
  ariac_msgs__srv__MoveAGV_Event__request__MAX_SIZE = 1
};
// response
enum
{
  ariac_msgs__srv__MoveAGV_Event__response__MAX_SIZE = 1
};

/// Struct defined in srv/MoveAGV in the package ariac_msgs.
typedef struct ariac_msgs__srv__MoveAGV_Event
{
  service_msgs__msg__ServiceEventInfo info;
  ariac_msgs__srv__MoveAGV_Request__Sequence request;
  ariac_msgs__srv__MoveAGV_Response__Sequence response;
} ariac_msgs__srv__MoveAGV_Event;

// Struct for a sequence of ariac_msgs__srv__MoveAGV_Event.
typedef struct ariac_msgs__srv__MoveAGV_Event__Sequence
{
