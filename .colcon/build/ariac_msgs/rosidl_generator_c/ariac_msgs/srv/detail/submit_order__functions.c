...
ariac_msgs__srv__SubmitOrder_Request__create()
{
  ...
  ariac_msgs__srv__SubmitOrder_Request * msg = (ariac_msgs__srv__SubmitOrder_Request *)allocator.allocate(sizeof(ariac_msgs__srv__SubmitOrder_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
...
ariac_msgs__srv__SubmitOrder_Request__Sequence__init(ariac_msgs__srv__SubmitOrder_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ariac_msgs__srv__SubmitOrder_Request *)allocator.zero_allocate(size, sizeof(ariac_msgs__srv__SubmitOrder_Request), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ariac_msgs__srv__SubmitOrder_Request__Sequence * array = (ariac_msgs__srv__SubmitOrder_Request__Sequence *)allocator.allocate(sizeof(ariac_msgs__srv__SubmitOrder_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  ariac_msgs__srv__SubmitOrder_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ariac_msgs__srv__SubmitOrder_Request * data =
      (ariac_msgs__srv__SubmitOrder_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ariac_msgs__srv__SubmitOrder_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ariac_msgs__srv__SubmitOrder_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ariac_msgs__srv__SubmitOrder_Response * msg = (ariac_msgs__srv__SubmitOrder_Response *)allocator.allocate(sizeof(ariac_msgs__srv__SubmitOrder_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
...
ariac_msgs__srv__SubmitOrder_Response__Sequence__init(ariac_msgs__srv__SubmitOrder_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (ariac_msgs__srv__SubmitOrder_Response *)allocator.zero_allocate(size, sizeof(ariac_msgs__srv__SubmitOrder_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ariac_msgs__srv__SubmitOrder_Response__Sequence * array = (ariac_msgs__srv__SubmitOrder_Response__Sequence *)allocator.allocate(sizeof(ariac_msgs__srv__SubmitOrder_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  ...
  ariac_msgs__srv__SubmitOrder_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    ariac_msgs__srv__SubmitOrder_Response * data =
      (ariac_msgs__srv__SubmitOrder_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ariac_msgs__srv__SubmitOrder_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ariac_msgs__srv__SubmitOrder_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
...
bool
ariac_msgs__srv__SubmitOrder_Event__init(ariac_msgs__srv__SubmitOrder_Event * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    ariac_msgs__srv__SubmitOrder_Event__fini(msg);
    return false;
  }
  // request
  if (!ariac_msgs__srv__SubmitOrder_Request__Sequence__init(&msg->request, 0)) {
    ariac_msgs__srv__SubmitOrder_Event__fini(msg);
    return false;
  }
  // response
  if (!ariac_msgs__srv__SubmitOrder_Response__Sequence__init(&msg->response, 0)) {
    ariac_msgs__srv__SubmitOrder_Event__fini(msg);
    return false;
  }
  return true;
...
void
ariac_msgs__srv__SubmitOrder_Event__fini(ariac_msgs__srv__SubmitOrder_Event * msg)
{
  if (!msg) {
    return;
  }
  ...
  // request
  ariac_msgs__srv__SubmitOrder_Request__Sequence__fini(&msg->request);
  // response
  ariac_msgs__srv__SubmitOrder_Response__Sequence__fini(&msg->response);
}

bool
ariac_msgs__srv__SubmitOrder_Event__are_equal(const ariac_msgs__srv__SubmitOrder_Event * lhs, const ariac_msgs__srv__SubmitOrder_Event * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  // request
  if (!ariac_msgs__srv__SubmitOrder_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!ariac_msgs__srv__SubmitOrder_Response__Sequence__are_equal(
...
bool
ariac_msgs__srv__SubmitOrder_Event__copy(
  const ariac_msgs__srv__SubmitOrder_Event * input,
  ariac_msgs__srv__SubmitOrder_Event * output)
{
  if (!input || !output) {
    return false;
  }
  ...
  // request
  if (!ariac_msgs__srv__SubmitOrder_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!ariac_msgs__srv__SubmitOrder_Response__Sequence__copy(
...
ariac_msgs__srv__SubmitOrder_Event *
ariac_msgs__srv__SubmitOrder_Event__create()
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ariac_msgs__srv__SubmitOrder_Event * msg = (ariac_msgs__srv__SubmitOrder_Event *)allocator.allocate(sizeof(ariac_msgs__srv__SubmitOrder_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ariac_msgs__srv__SubmitOrder_Event));
  bool success = ariac_msgs__srv__SubmitOrder_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
void
ariac_msgs__srv__SubmitOrder_Event__destroy(ariac_msgs__srv__SubmitOrder_Event * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ariac_msgs__srv__SubmitOrder_Event__fini(msg);
...
bool
ariac_msgs__srv__SubmitOrder_Event__Sequence__init(ariac_msgs__srv__SubmitOrder_Event__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ariac_msgs__srv__SubmitOrder_Event * data = NULL;

  if (size) {
    data = (ariac_msgs__srv__SubmitOrder_Event *)allocator.zero_allocate(size, sizeof(ariac_msgs__srv__SubmitOrder_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ariac_msgs__srv__SubmitOrder_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ariac_msgs__srv__SubmitOrder_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
void
ariac_msgs__srv__SubmitOrder_Event__Sequence__fini(ariac_msgs__srv__SubmitOrder_Event__Sequence * array)
{
  if (!array) {
    return;
  }
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ariac_msgs__srv__SubmitOrder_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
ariac_msgs__srv__SubmitOrder_Event__Sequence *
ariac_msgs__srv__SubmitOrder_Event__Sequence__create(size_t size)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ariac_msgs__srv__SubmitOrder_Event__Sequence * array = (ariac_msgs__srv__SubmitOrder_Event__Sequence *)allocator.allocate(sizeof(ariac_msgs__srv__SubmitOrder_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ariac_msgs__srv__SubmitOrder_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
void
ariac_msgs__srv__SubmitOrder_Event__Sequence__destroy(ariac_msgs__srv__SubmitOrder_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ariac_msgs__srv__SubmitOrder_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}

bool
ariac_msgs__srv__SubmitOrder_Event__Sequence__are_equal(const ariac_msgs__srv__SubmitOrder_Event__Sequence * lhs, const ariac_msgs__srv__SubmitOrder_Event__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ariac_msgs__srv__SubmitOrder_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
ariac_msgs__srv__SubmitOrder_Event__Sequence__copy(
  const ariac_msgs__srv__SubmitOrder_Event__Sequence * input,
  ariac_msgs__srv__SubmitOrder_Event__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ariac_msgs__srv__SubmitOrder_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ariac_msgs__srv__SubmitOrder_Event * data =
      (ariac_msgs__srv__SubmitOrder_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ariac_msgs__srv__SubmitOrder_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ariac_msgs__srv__SubmitOrder_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ariac_msgs__srv__SubmitOrder_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
