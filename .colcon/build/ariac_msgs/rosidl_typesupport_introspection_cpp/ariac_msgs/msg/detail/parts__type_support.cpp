...
void fetch_function__Parts__parts(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const ariac_msgs::msg::Part *>(
    get_const_function__Parts__parts(untyped_member, index));
  auto & value = *reinterpret_cast<ariac_msgs::msg::Part *>(untyped_value);
  value = item;
}

void assign_function__Parts__parts(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<ariac_msgs::msg::Part *>(
    get_function__Parts__parts(untyped_member, index));
  const auto & value = *reinterpret_cast<const ariac_msgs::msg::Part *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Parts_message_member_array[1] = {
  {
    ...
    fetch_function__Parts__parts,  // fetch(index, &value) function pointer
    assign_function__Parts__parts,  // assign(index, value) function pointer
