...
void fetch_function__BinParts__bins(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const ariac_msgs::msg::BinInfo *>(
    get_const_function__BinParts__bins(untyped_member, index));
  auto & value = *reinterpret_cast<ariac_msgs::msg::BinInfo *>(untyped_value);
  value = item;
}

void assign_function__BinParts__bins(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<ariac_msgs::msg::BinInfo *>(
    get_function__BinParts__bins(untyped_member, index));
  const auto & value = *reinterpret_cast<const ariac_msgs::msg::BinInfo *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BinParts_message_member_array[1] = {
  {
    ...
    fetch_function__BinParts__bins,  // fetch(index, &value) function pointer
    assign_function__BinParts__bins,  // assign(index, value) function pointer
