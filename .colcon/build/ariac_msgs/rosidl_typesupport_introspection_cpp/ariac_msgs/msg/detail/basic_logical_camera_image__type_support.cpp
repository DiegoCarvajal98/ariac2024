...
void fetch_function__BasicLogicalCameraImage__part_poses(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::Pose *>(
    get_const_function__BasicLogicalCameraImage__part_poses(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::Pose *>(untyped_value);
  value = item;
}

void assign_function__BasicLogicalCameraImage__part_poses(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::Pose *>(
    get_function__BasicLogicalCameraImage__part_poses(untyped_member, index));
...
void fetch_function__BasicLogicalCameraImage__tray_poses(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const geometry_msgs::msg::Pose *>(
    get_const_function__BasicLogicalCameraImage__tray_poses(untyped_member, index));
  auto & value = *reinterpret_cast<geometry_msgs::msg::Pose *>(untyped_value);
  value = item;
}

void assign_function__BasicLogicalCameraImage__tray_poses(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<geometry_msgs::msg::Pose *>(
    get_function__BasicLogicalCameraImage__tray_poses(untyped_member, index));
  const auto & value = *reinterpret_cast<const geometry_msgs::msg::Pose *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BasicLogicalCameraImage_message_member_array[4] = {
  {
    "header",  // name
    ...
    offsetof(ariac_msgs::msg::BasicLogicalCameraImage, header),  // bytes offset in struct
  ...
  },
  {
    ...
    fetch_function__BasicLogicalCameraImage__part_poses,  // fetch(index, &value) function pointer
    assign_function__BasicLogicalCameraImage__part_poses,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    fetch_function__BasicLogicalCameraImage__tray_poses,  // fetch(index, &value) function pointer
    assign_function__BasicLogicalCameraImage__tray_poses,  // assign(index, value) function pointer
