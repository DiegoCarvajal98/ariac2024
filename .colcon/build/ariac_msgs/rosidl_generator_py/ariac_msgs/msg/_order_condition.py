...
class Metaclass_OrderCondition(type):
    """Metaclass of message 'OrderCondition'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__order_condition
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__order_condition
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__order_condition
            cls._TYPE_SUPPORT = module.type_support_msg__msg__order_condition
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__order_condition
    ...
    def KITTING(self):
        ...
        return Metaclass_OrderCondition.__constants['KITTING']

    @property
    def ASSEMBLY(self):
        """Message constant 'ASSEMBLY'."""
        return Metaclass_OrderCondition.__constants['ASSEMBLY']

    @property
    def COMBINED(self):
        """Message constant 'COMBINED'."""
        return Metaclass_OrderCondition.__constants['COMBINED']


class OrderCondition(metaclass=Metaclass_OrderCondition):
    """
    Message class 'OrderCondition'.
