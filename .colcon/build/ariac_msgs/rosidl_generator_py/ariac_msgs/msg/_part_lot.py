...
class Metaclass_PartLot(type):
    """Metaclass of message 'PartLot'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__part_lot
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__part_lot
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__part_lot
            cls._TYPE_SUPPORT = module.type_support_msg__msg__part_lot
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__part_lot
...
class PartLot(metaclass=Metaclass_PartLot):
    """Message class 'PartLot'."""
    ...
    def quantity(self, value):
        if self._check_fields:
            ...
            assert value >= 0 and value < 256, \
                "The 'quantity' field must be an unsigned integer in [0, 255]"
