...
class Metaclass_CombinedTask(type):
    """Metaclass of message 'CombinedTask'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__combined_task
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__combined_task
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__combined_task
            cls._TYPE_SUPPORT = module.type_support_msg__msg__combined_task
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__combined_task
    ...
    def AS1(self):
        ...
        return Metaclass_CombinedTask.__constants['AS1']

    @property
    def AS2(self):
        """Message constant 'AS2'."""
        return Metaclass_CombinedTask.__constants['AS2']

    @property
    def AS3(self):
        """Message constant 'AS3'."""
        return Metaclass_CombinedTask.__constants['AS3']

    @property
    def AS4(self):
        """Message constant 'AS4'."""
        return Metaclass_CombinedTask.__constants['AS4']


class CombinedTask(metaclass=Metaclass_CombinedTask):
    """
    Message class 'CombinedTask'.
