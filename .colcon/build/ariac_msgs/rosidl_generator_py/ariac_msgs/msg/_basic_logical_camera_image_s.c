...
bool ariac_msgs__msg__basic_logical_camera_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ariac_msgs.msg._basic_logical_camera_image.BasicLogicalCameraImage", full_classname_dest, 66) == 0);
  }
  ariac_msgs__msg__BasicLogicalCameraImage * ros_message = _ros_message;
  {  // header
  ...
  {  // part_poses
    ...
    geometry_msgs__msg__Pose * dest = ros_message->part_poses.data;
  ...
  {  // tray_poses
    ...
    geometry_msgs__msg__Pose * dest = ros_message->tray_poses.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!geometry_msgs__msg__pose__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of BasicLogicalCameraImage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ariac_msgs.msg._basic_logical_camera_image");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BasicLogicalCameraImage");
