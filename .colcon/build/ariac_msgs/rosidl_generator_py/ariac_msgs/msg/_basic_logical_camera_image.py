...
class Metaclass_BasicLogicalCameraImage(type):
    """Metaclass of message 'BasicLogicalCameraImage'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__basic_logical_camera_image
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__basic_logical_camera_image
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__basic_logical_camera_image
            cls._TYPE_SUPPORT = module.type_support_msg__msg__basic_logical_camera_image
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__basic_logical_camera_image
...
class BasicLogicalCameraImage(metaclass=Metaclass_BasicLogicalCameraImage):
    """Message class 'BasicLogicalCameraImage'."""
    ...
    _fields_and_field_types = {
        ...
        'part_poses': 'sequence<geometry_msgs/Pose>',
        'tray_poses': 'sequence<geometry_msgs/Pose>',
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'part_poses' field must be a set or sequence and each value of type 'Pose'"
        ...
        if self._check_fields:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, Pose) for v in value) and
                 True), \
                "The 'tray_poses' field must be a set or sequence and each value of type 'Pose'"
