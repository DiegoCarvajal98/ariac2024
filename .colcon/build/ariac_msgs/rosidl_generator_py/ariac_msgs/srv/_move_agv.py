...
class Metaclass_MoveAGV_Event(type):
    """Metaclass of message 'MoveAGV_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__move_agv__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__move_agv__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__move_agv__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__move_agv__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__move_agv__event
...
class MoveAGV_Event(metaclass=Metaclass_MoveAGV_Event):
    """Message class 'MoveAGV_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ariac_msgs/MoveAGV_Request, 1>',
        'response': 'sequence<ariac_msgs/MoveAGV_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ariac_msgs', 'srv'], 'MoveAGV_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ariac_msgs', 'srv'], 'MoveAGV_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ariac_msgs.srv import MoveAGV_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, MoveAGV_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'MoveAGV_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from ariac_msgs.srv import MoveAGV_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, MoveAGV_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'MoveAGV_Response'"
...
class Metaclass_MoveAGV(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _move_agv.Metaclass_MoveAGV_Event._TYPE_SUPPORT is None:
                _move_agv.Metaclass_MoveAGV_Event.__import_type_support__()
...
class MoveAGV(metaclass=Metaclass_MoveAGV):
    ...
    from ariac_msgs.srv._move_agv import MoveAGV_Event as Event
