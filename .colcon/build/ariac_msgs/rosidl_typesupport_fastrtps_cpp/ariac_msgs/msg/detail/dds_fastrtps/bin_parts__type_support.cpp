...
#include "ariac_msgs/msg/detail/bin_parts__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ariac_msgs::msg::BinParts & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ariac_msgs::msg::BinParts & ros_message)
{
  // Member: bins
  {
    uint32_t cdrSize;
  ...
  // Member: bins
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.bins[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: bins
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ariac_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_BinInfo(
  ...
  if (is_plain) {
    ...
    using DataType = ariac_msgs::msg::BinParts;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ariac_msgs::msg::BinParts *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ariac_msgs::msg::BinParts *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BinParts__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ariac_msgs::msg::BinParts *>(
...
static size_t _BinParts__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_BinParts(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BinParts__callbacks = {
  "ariac_msgs::msg",
  "BinParts",
...
static rosidl_message_type_support_t _BinParts__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_BinParts__callbacks,
...
{
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_BinParts__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ariac_msgs, msg, BinParts)() {
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_BinParts__handle;
}
