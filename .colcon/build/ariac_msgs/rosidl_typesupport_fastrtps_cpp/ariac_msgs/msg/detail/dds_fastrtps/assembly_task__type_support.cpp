...
#include "ariac_msgs/msg/detail/assembly_task__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ariac_msgs::msg::AssemblyTask;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ariac_msgs::msg::AssemblyTask *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ariac_msgs::msg::AssemblyTask *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AssemblyTask__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ariac_msgs::msg::AssemblyTask *>(
...
static size_t _AssemblyTask__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_AssemblyTask(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AssemblyTask__callbacks = {
  "ariac_msgs::msg",
  "AssemblyTask",
...
static rosidl_message_type_support_t _AssemblyTask__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AssemblyTask__callbacks,
...
{
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_AssemblyTask__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ariac_msgs, msg, AssemblyTask)() {
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_AssemblyTask__handle;
}
