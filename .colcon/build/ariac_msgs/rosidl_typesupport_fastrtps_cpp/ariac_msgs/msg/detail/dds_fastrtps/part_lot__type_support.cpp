...
#include "ariac_msgs/msg/detail/part_lot__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ariac_msgs::msg::PartLot & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ariac_msgs::msg::PartLot & ros_message)
{
  // Member: part
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ariac_msgs::msg::PartLot;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ariac_msgs::msg::PartLot *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ariac_msgs::msg::PartLot *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _PartLot__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ariac_msgs::msg::PartLot *>(
...
static size_t _PartLot__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_PartLot(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _PartLot__callbacks = {
  "ariac_msgs::msg",
  "PartLot",
...
static rosidl_message_type_support_t _PartLot__handle = {
...
{
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_PartLot__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ariac_msgs, msg, PartLot)() {
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_PartLot__handle;
}
