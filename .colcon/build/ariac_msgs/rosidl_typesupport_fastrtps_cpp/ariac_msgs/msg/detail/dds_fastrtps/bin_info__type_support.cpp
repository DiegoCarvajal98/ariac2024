...
#include "ariac_msgs/msg/detail/bin_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ariac_msgs::msg::BinInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ariac_msgs::msg::BinInfo & ros_message)
{
  // Member: bin_number
  cdr >> ros_message.bin_number;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ariac_msgs::msg::BinInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ariac_msgs::msg::BinInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ariac_msgs::msg::BinInfo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _BinInfo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const ariac_msgs::msg::BinInfo *>(
...
static size_t _BinInfo__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_BinInfo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _BinInfo__callbacks = {
  "ariac_msgs::msg",
  "BinInfo",
...
static rosidl_message_type_support_t _BinInfo__handle = {
...
{
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_BinInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ariac_msgs, msg, BinInfo)() {
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_BinInfo__handle;
}
