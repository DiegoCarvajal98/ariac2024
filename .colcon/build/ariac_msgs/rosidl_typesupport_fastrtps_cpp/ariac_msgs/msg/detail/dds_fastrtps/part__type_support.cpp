...
#include "ariac_msgs/msg/detail/part__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ariac_msgs::msg::Part & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ariac_msgs::msg::Part & ros_message)
{
  // Member: color
  cdr >> ros_message.color;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ariac_msgs::msg::Part;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ariac_msgs::msg::Part *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ariac_msgs::msg::Part *>(
    untyped_ros_message);
...
{
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_Part__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ariac_msgs, msg, Part)() {
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_Part__handle;
}
