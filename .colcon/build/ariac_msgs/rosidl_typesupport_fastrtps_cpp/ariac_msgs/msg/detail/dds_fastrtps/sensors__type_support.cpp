...
#include "ariac_msgs/msg/detail/sensors__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ariac_msgs::msg::Sensors & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ariac_msgs::msg::Sensors & ros_message)
{
  // Member: break_beam
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ariac_msgs::msg::Sensors;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ariac_msgs::msg::Sensors *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ariac_msgs::msg::Sensors *>(
    untyped_ros_message);
...
static size_t _Sensors__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_Sensors(full_bounded, is_plain, 0);
...
{
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_Sensors__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ariac_msgs, msg, Sensors)() {
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_Sensors__handle;
}
