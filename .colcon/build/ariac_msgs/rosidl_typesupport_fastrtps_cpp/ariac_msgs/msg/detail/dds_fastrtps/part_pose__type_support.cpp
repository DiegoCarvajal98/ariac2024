...
#include "ariac_msgs/msg/detail/part_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ariac_msgs::msg::PartPose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ariac_msgs::msg::PartPose & ros_message)
{
  // Member: part
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ariac_msgs::msg::PartPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ariac_msgs::msg::PartPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ariac_msgs::msg::PartPose *>(
    untyped_ros_message);
...
static size_t _PartPose__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_PartPose(full_bounded, is_plain, 0);
...
{
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_PartPose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ariac_msgs, msg, PartPose)() {
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_PartPose__handle;
}
