...
#include "ariac_msgs/msg/detail/conveyor_belt_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ariac_msgs::msg::ConveyorBeltState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ariac_msgs::msg::ConveyorBeltState & ros_message)
{
  // Member: power
  cdr >> ros_message.power;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ariac_msgs::msg::ConveyorBeltState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ariac_msgs::msg::ConveyorBeltState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ariac_msgs::msg::ConveyorBeltState *>(
    untyped_ros_message);
...
{
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_ConveyorBeltState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ariac_msgs, msg, ConveyorBeltState)() {
  return &ariac_msgs::msg::typesupport_fastrtps_cpp::_ConveyorBeltState__handle;
}
