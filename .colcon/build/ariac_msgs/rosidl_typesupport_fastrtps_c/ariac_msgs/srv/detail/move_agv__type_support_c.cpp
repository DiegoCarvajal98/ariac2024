  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ariac_msgs__srv__MoveAGV_Request;
    is_plain =
      (
...
static size_t _MoveAGV_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ariac_msgs__srv__MoveAGV_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ariac_msgs__srv__MoveAGV_Response;
    is_plain =
      (
...
static size_t _MoveAGV_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ariac_msgs__srv__MoveAGV_Response(
    full_bounded, is_plain, 0);
...
using _MoveAGV_Event__ros_msg_type = ariac_msgs__srv__MoveAGV_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _MoveAGV_Event__ros_msg_type * ros_message = static_cast<const _MoveAGV_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ariac_msgs, srv, MoveAGV_Request
      )()->data);
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ariac_msgs, srv, MoveAGV_Response
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _MoveAGV_Event__ros_msg_type * ros_message = static_cast<_MoveAGV_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      ariac_msgs__srv__MoveAGV_Request__Sequence__fini(&ros_message->request);
    }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      ariac_msgs__srv__MoveAGV_Response__Sequence__fini(&ros_message->response);
    }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ariac_msgs
size_t get_serialized_size_ariac_msgs__srv__MoveAGV_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveAGV_Event__ros_msg_type * ros_message = static_cast<const _MoveAGV_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ariac_msgs__srv__MoveAGV_Request(
  ...
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ariac_msgs__srv__MoveAGV_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
static uint32_t _MoveAGV_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ariac_msgs__srv__MoveAGV_Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ariac_msgs
size_t max_serialized_size_ariac_msgs__srv__MoveAGV_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ariac_msgs__srv__MoveAGV_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ariac_msgs__srv__MoveAGV_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ariac_msgs__srv__MoveAGV_Event;
    is_plain =
      (
...
static size_t _MoveAGV_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ariac_msgs__srv__MoveAGV_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_MoveAGV_Event = {
  "ariac_msgs::srv",
  "MoveAGV_Event",
...
static rosidl_message_type_support_t _MoveAGV_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_MoveAGV_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ariac_msgs, srv, MoveAGV_Event)() {
  return &_MoveAGV_Event__type_support;
}
...
static rosidl_service_type_support_t MoveAGV__handle = {
  ...
  &_MoveAGV_Request__type_support,
  &_MoveAGV_Response__type_support,
  &_MoveAGV_Event__type_support,
