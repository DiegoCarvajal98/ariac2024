...
#include "ariac_msgs/msg/detail/combined_task__rosidl_typesupport_fastrtps_c.h"
...
using _CombinedTask__ros_msg_type = ariac_msgs__msg__CombinedTask;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _CombinedTask__ros_msg_type * ros_message = static_cast<const _CombinedTask__ros_msg_type *>(untyped_ros_message);
  // Field name: station
  {
  ...
  void * untyped_ros_message)
{
  ...
  _CombinedTask__ros_msg_type * ros_message = static_cast<_CombinedTask__ros_msg_type *>(untyped_ros_message);
  // Field name: station
  {
    cdr >> ros_message->station;
  }
...
static uint32_t _CombinedTask__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ariac_msgs__msg__CombinedTask(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ariac_msgs__msg__CombinedTask;
    is_plain =
      (
...
static size_t _CombinedTask__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ariac_msgs__msg__CombinedTask(
...
static message_type_support_callbacks_t __callbacks_CombinedTask = {
  "ariac_msgs::msg",
  "CombinedTask",
...
static rosidl_message_type_support_t _CombinedTask__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_CombinedTask,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ariac_msgs, msg, CombinedTask)() {
  return &_CombinedTask__type_support;
}
