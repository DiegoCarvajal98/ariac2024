...
#include "ariac_msgs/msg/detail/part_pose__rosidl_typesupport_fastrtps_c.h"
...
using _PartPose__ros_msg_type = ariac_msgs__msg__PartPose;
...
static uint32_t _PartPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ariac_msgs__msg__PartPose(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ariac_msgs__msg__PartPose;
    is_plain =
      (
...
static size_t _PartPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ariac_msgs__msg__PartPose(
