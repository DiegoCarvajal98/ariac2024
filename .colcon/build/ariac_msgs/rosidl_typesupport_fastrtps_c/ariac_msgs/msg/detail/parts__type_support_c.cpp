...
#include "ariac_msgs/msg/detail/parts__rosidl_typesupport_fastrtps_c.h"
...
#include "ariac_msgs/msg/detail/part__functions.h"  // parts
...
using _Parts__ros_msg_type = ariac_msgs__msg__Parts;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Parts__ros_msg_type * ros_message = static_cast<const _Parts__ros_msg_type *>(untyped_ros_message);
  // Field name: parts
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Parts__ros_msg_type * ros_message = static_cast<_Parts__ros_msg_type *>(untyped_ros_message);
  // Field name: parts
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
    ...
    if (ros_message->parts.data) {
      ariac_msgs__msg__Part__Sequence__fini(&ros_message->parts);
    }
    if (!ariac_msgs__msg__Part__Sequence__init(&ros_message->parts, size)) {
...
size_t get_serialized_size_ariac_msgs__msg__Parts(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Parts__ros_msg_type * ros_message = static_cast<const _Parts__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Parts__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ariac_msgs__msg__Parts(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ariac_msgs
size_t max_serialized_size_ariac_msgs__msg__Parts(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ariac_msgs__msg__Parts;
    is_plain =
      (
...
static size_t _Parts__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ariac_msgs__msg__Parts(
...
static message_type_support_callbacks_t __callbacks_Parts = {
  "ariac_msgs::msg",
  "Parts",
...
static rosidl_message_type_support_t _Parts__type_support = {
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ariac_msgs, msg, Parts)() {
  return &_Parts__type_support;
}
