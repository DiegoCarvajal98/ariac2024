...
#include "ariac_msgs/msg/detail/kitting_part__rosidl_typesupport_fastrtps_c.h"
...
using _KittingPart__ros_msg_type = ariac_msgs__msg__KittingPart;

static bool _KittingPart__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _KittingPart__ros_msg_type * ros_message = static_cast<const _KittingPart__ros_msg_type *>(untyped_ros_message);
  // Field name: part
  {
  ...
  // Field name: quadrant
  {
    cdr << ros_message->quadrant;
  }

  return true;
}

static bool _KittingPart__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _KittingPart__ros_msg_type * ros_message = static_cast<_KittingPart__ros_msg_type *>(untyped_ros_message);
  // Field name: part
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  // field.name quadrant
  {
    size_t item_size = sizeof(ros_message->quadrant);
...
static uint32_t _KittingPart__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ariac_msgs__msg__KittingPart(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ariac_msgs__msg__KittingPart;
    is_plain =
      (
      offsetof(DataType, quadrant) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _KittingPart__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_ariac_msgs__msg__KittingPart(
...
static message_type_support_callbacks_t __callbacks_KittingPart = {
  "ariac_msgs::msg",
  "KittingPart",
  _KittingPart__cdr_serialize,
  _KittingPart__cdr_deserialize,
  _KittingPart__get_serialized_size,
  _KittingPart__max_serialized_size
};

static rosidl_message_type_support_t _KittingPart__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_KittingPart,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ariac_msgs, msg, KittingPart)() {
  return &_KittingPart__type_support;
}
