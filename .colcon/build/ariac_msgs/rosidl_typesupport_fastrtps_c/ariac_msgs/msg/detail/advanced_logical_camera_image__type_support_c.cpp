...
#include "ariac_msgs/msg/detail/advanced_logical_camera_image__rosidl_typesupport_fastrtps_c.h"
...
#include "ariac_msgs/msg/detail/kit_tray_pose__functions.h"  // tray_poses
#include "ariac_msgs/msg/detail/part_pose__functions.h"  // part_poses
#include "geometry_msgs/msg/detail/pose__functions.h"  // sensor_pose
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_ariac_msgs__msg__KitTrayPose(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_ariac_msgs__msg__KitTrayPose(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ariac_msgs, msg, KitTrayPose)();
...
using _AdvancedLogicalCameraImage__ros_msg_type = ariac_msgs__msg__AdvancedLogicalCameraImage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: tray_poses
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ariac_msgs, msg, KitTrayPose
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: part_poses
  {
    ...
    if (ros_message->part_poses.data) {
      ariac_msgs__msg__PartPose__Sequence__fini(&ros_message->part_poses);
    }
  ...
  // Field name: tray_poses
  {
    ...
    if (ros_message->tray_poses.data) {
      ariac_msgs__msg__KitTrayPose__Sequence__fini(&ros_message->tray_poses);
    }
...
size_t get_serialized_size_ariac_msgs__msg__AdvancedLogicalCameraImage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AdvancedLogicalCameraImage__ros_msg_type * ros_message = static_cast<const _AdvancedLogicalCameraImage__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name tray_poses
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ariac_msgs__msg__KitTrayPose(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name sensor_pose
...
static uint32_t _AdvancedLogicalCameraImage__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ariac_msgs__msg__AdvancedLogicalCameraImage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ariac_msgs
size_t max_serialized_size_ariac_msgs__msg__AdvancedLogicalCameraImage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: tray_poses
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ariac_msgs__msg__KitTrayPose(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = ariac_msgs__msg__AdvancedLogicalCameraImage;
    is_plain =
      (
...
static size_t _AdvancedLogicalCameraImage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ariac_msgs__msg__AdvancedLogicalCameraImage(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ariac_msgs, msg, AdvancedLogicalCameraImage)() {
