...
#ifndef ARIAC_MSGS__MSG__DETAIL__SENSORS__STRUCT_HPP_
#define ARIAC_MSGS__MSG__DETAIL__SENSORS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__ariac_msgs__msg__Sensors __attribute__((deprecated))
#else
# define DEPRECATED__ariac_msgs__msg__Sensors __declspec(deprecated)
#endif
...
struct Sensors_
{
  ...
  using ConstRawPtr =
    const ariac_msgs::msg::Sensors_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<ariac_msgs::msg::Sensors_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<ariac_msgs::msg::Sensors_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      ariac_msgs::msg::Sensors_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<ariac_msgs::msg::Sensors_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<ariac_msgs::msg::Sensors_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<ariac_msgs::msg::Sensors_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<ariac_msgs::msg::Sensors_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__ariac_msgs__msg__Sensors
    std::shared_ptr<ariac_msgs::msg::Sensors_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__ariac_msgs__msg__Sensors
    std::shared_ptr<ariac_msgs::msg::Sensors_<ContainerAllocator> const>
...
using Sensors =
  ariac_msgs::msg::Sensors_<std::allocator<void>>;
...
#endif  // ARIAC_MSGS__MSG__DETAIL__SENSORS__STRUCT_HPP_
