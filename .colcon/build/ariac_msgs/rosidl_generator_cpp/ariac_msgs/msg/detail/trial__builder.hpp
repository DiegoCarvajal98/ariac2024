...
class Init_Trial_log_folder_path
{
public:
  explicit Init_Trial_log_folder_path(::ariac_msgs::msg::Trial & msg)
  : msg_(msg)
  {}
  Init_Trial_orders log_folder_path(::ariac_msgs::msg::Trial::_log_folder_path_type arg)
  {
    msg_.log_folder_path = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_Trial_log_folder_path trial_name(::ariac_msgs::msg::Trial::_trial_name_type arg)
  {
    msg_.trial_name = std::move(arg);
    return Init_Trial_log_folder_path(msg_);
  }
