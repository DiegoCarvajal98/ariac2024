...
{
public:
  explicit Init_AdvancedLogicalCameraImage_part_poses(::ariac_msgs::msg::AdvancedLogicalCameraImage & msg)
  : msg_(msg)
  {}
...
class Init_AdvancedLogicalCameraImage_header
{
public:
  Init_AdvancedLogicalCameraImage_header()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_AdvancedLogicalCameraImage_part_poses header(::ariac_msgs::msg::AdvancedLogicalCameraImage::_header_type arg)
  {
    msg_.header = std::move(arg);
    return Init_AdvancedLogicalCameraImage_part_poses(msg_);
  }
...
{
  return ariac_msgs::msg::builder::Init_AdvancedLogicalCameraImage_header();
}
