...
inline void to_flow_style_yaml(
  const SensorBlackoutChallenge & msg,
  std::ostream & out)
{
  out << "{";
  // member: duration
  ...
  // member: sensors_to_disable
  {
    ...
    to_flow_style_yaml(msg.sensors_to_disable, out);
  }
  out << "}";
  ...
  std::ostream & out, size_t indentation = 0)
{
  ...
  // member: sensors_to_disable
  {
    ...
    out << "sensors_to_disable:\n";
    to_block_style_yaml(msg.sensors_to_disable, out, indentation + 2);
  }
}  // NOLINT(readability/fn_size)

inline std::string to_yaml(const SensorBlackoutChallenge & msg, bool use_flow_style = false)
{
