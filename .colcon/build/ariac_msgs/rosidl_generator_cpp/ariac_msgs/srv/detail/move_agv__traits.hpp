...
inline std::string to_yaml(const MoveAGV_Request & msg, bool use_flow_style = false)
{
...
inline std::string to_yaml(const MoveAGV_Response & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
inline std::string to_yaml(const MoveAGV_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use ariac_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const ariac_msgs::srv::MoveAGV_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  ariac_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use ariac_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const ariac_msgs::srv::MoveAGV_Event & msg)
{
  return ariac_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<ariac_msgs::srv::MoveAGV_Event>()
{
  return "ariac_msgs::srv::MoveAGV_Event";
}

template<>
inline const char * name<ariac_msgs::srv::MoveAGV_Event>()
{
  return "ariac_msgs/srv/MoveAGV_Event";
}

template<>
struct has_fixed_size<ariac_msgs::srv::MoveAGV_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<ariac_msgs::srv::MoveAGV_Event>
  : std::integral_constant<bool, has_bounded_size<ariac_msgs::srv::MoveAGV_Request>::value && has_bounded_size<ariac_msgs::srv::MoveAGV_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<ariac_msgs::srv::MoveAGV_Event>
  : std::true_type {};
