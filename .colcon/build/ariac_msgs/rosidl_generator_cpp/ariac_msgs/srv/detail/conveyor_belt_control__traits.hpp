...
inline void to_flow_style_yaml(
  const ConveyorBeltControl_Event & msg,
  std::ostream & out)
{
  out << "{";
  // member: info
...
inline std::string to_yaml(const ConveyorBeltControl_Event & msg, bool use_flow_style = false)
{
  std::ostringstream out;
  if (use_flow_style) {
    to_flow_style_yaml(msg, out);
...
[[deprecated("use ariac_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const ariac_msgs::srv::ConveyorBeltControl_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  ariac_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use ariac_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const ariac_msgs::srv::ConveyorBeltControl_Event & msg)
{
  return ariac_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<ariac_msgs::srv::ConveyorBeltControl_Event>()
{
  return "ariac_msgs::srv::ConveyorBeltControl_Event";
}

template<>
inline const char * name<ariac_msgs::srv::ConveyorBeltControl_Event>()
{
  return "ariac_msgs/srv/ConveyorBeltControl_Event";
}

template<>
struct has_fixed_size<ariac_msgs::srv::ConveyorBeltControl_Event>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<ariac_msgs::srv::ConveyorBeltControl_Event>
  : std::integral_constant<bool, has_bounded_size<ariac_msgs::srv::ConveyorBeltControl_Request>::value && has_bounded_size<ariac_msgs::srv::ConveyorBeltControl_Response>::value && has_bounded_size<service_msgs::msg::ServiceEventInfo>::value> {};

template<>
struct is_message<ariac_msgs::srv::ConveyorBeltControl_Event>
  : std::true_type {};
