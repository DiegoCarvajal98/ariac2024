...
void ariac_msgs__msg__Order__rosidl_typesupport_introspection_c__Order_init_function(
...
void ariac_msgs__msg__Order__rosidl_typesupport_introspection_c__Order_fini_function(void * message_memory)
{
  ariac_msgs__msg__Order__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ariac_msgs__msg__Order__rosidl_typesupport_introspection_c__Order_message_member_array[6] = {
  {
    "id",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers ariac_msgs__msg__Order__rosidl_typesupport_introspection_c__Order_message_members = {
  "ariac_msgs__msg",  // message namespace
  "Order",  // message name
  6,  // number of fields
  sizeof(ariac_msgs__msg__Order),
  ariac_msgs__msg__Order__rosidl_typesupport_introspection_c__Order_message_member_array,  // message members
  ariac_msgs__msg__Order__rosidl_typesupport_introspection_c__Order_init_function,  // function to initialize message memory (memory has to be allocated)
  ariac_msgs__msg__Order__rosidl_typesupport_introspection_c__Order_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t ariac_msgs__msg__Order__rosidl_typesupport_introspection_c__Order_message_type_support_handle = {
  0,
  &ariac_msgs__msg__Order__rosidl_typesupport_introspection_c__Order_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ariac_msgs, msg, Order)() {
  ariac_msgs__msg__Order__rosidl_typesupport_introspection_c__Order_message_member_array[3].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ariac_msgs, msg, KittingTask)();
  ariac_msgs__msg__Order__rosidl_typesupport_introspection_c__Order_message_member_array[4].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ariac_msgs, msg, AssemblyTask)();
  ariac_msgs__msg__Order__rosidl_typesupport_introspection_c__Order_message_member_array[5].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ariac_msgs, msg, CombinedTask)();
  if (!ariac_msgs__msg__Order__rosidl_typesupport_introspection_c__Order_message_type_support_handle.typesupport_identifier) {
    ariac_msgs__msg__Order__rosidl_typesupport_introspection_c__Order_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &ariac_msgs__msg__Order__rosidl_typesupport_introspection_c__Order_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
