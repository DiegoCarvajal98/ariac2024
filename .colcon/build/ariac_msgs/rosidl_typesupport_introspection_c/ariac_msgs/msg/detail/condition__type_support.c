...
void ariac_msgs__msg__Condition__rosidl_typesupport_introspection_c__Condition_init_function(
...
void ariac_msgs__msg__Condition__rosidl_typesupport_introspection_c__Condition_fini_function(void * message_memory)
{
  ariac_msgs__msg__Condition__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ariac_msgs__msg__Condition__rosidl_typesupport_introspection_c__Condition_message_member_array[4] = {
  {
    "type",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers ariac_msgs__msg__Condition__rosidl_typesupport_introspection_c__Condition_message_members = {
  "ariac_msgs__msg",  // message namespace
  "Condition",  // message name
  4,  // number of fields
  sizeof(ariac_msgs__msg__Condition),
  ariac_msgs__msg__Condition__rosidl_typesupport_introspection_c__Condition_message_member_array,  // message members
  ariac_msgs__msg__Condition__rosidl_typesupport_introspection_c__Condition_init_function,  // function to initialize message memory (memory has to be allocated)
  ariac_msgs__msg__Condition__rosidl_typesupport_introspection_c__Condition_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t ariac_msgs__msg__Condition__rosidl_typesupport_introspection_c__Condition_message_type_support_handle = {
  0,
  &ariac_msgs__msg__Condition__rosidl_typesupport_introspection_c__Condition_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ariac_msgs, msg, Condition)() {
  ariac_msgs__msg__Condition__rosidl_typesupport_introspection_c__Condition_message_member_array[1].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ariac_msgs, msg, TimeCondition)();
  ariac_msgs__msg__Condition__rosidl_typesupport_introspection_c__Condition_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ariac_msgs, msg, PartPlaceCondition)();
  ariac_msgs__msg__Condition__rosidl_typesupport_introspection_c__Condition_message_member_array[3].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, ariac_msgs, msg, SubmissionCondition)();
  if (!ariac_msgs__msg__Condition__rosidl_typesupport_introspection_c__Condition_message_type_support_handle.typesupport_identifier) {
    ariac_msgs__msg__Condition__rosidl_typesupport_introspection_c__Condition_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &ariac_msgs__msg__Condition__rosidl_typesupport_introspection_c__Condition_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
