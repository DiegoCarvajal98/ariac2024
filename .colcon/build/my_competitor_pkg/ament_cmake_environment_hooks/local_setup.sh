...
: ${AMENT_CURRENT_PREFIX:="/overlay_ws/install/my_competitor_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_competitor_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_competitor_pkg/environment/path.sh"
